...
// Entidad PagoTransferencia - Método de pago mediante transferencia bancaria. Extiende de MetodoPago usando herencia JOINED.
@Entity
...
public class PagoTransferencia extends MetodoPago {
	...
	public boolean esValido() {
		return iban != null && !iban.isEmpty() && nombreTitular != null && !nombreTitular.isEmpty();
	}

	// Valida el formato básico del IBAN. @return true si el formato es válido
