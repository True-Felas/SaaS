...
// Entidad PagoTarjeta - Método de pago con tarjeta de crédito/débito. Extiende de MetodoPago usando herencia JOINED.
@Entity
...
public class PagoTarjeta extends MetodoPago {
	...
	// Verifica si la tarjeta está próxima a expirar (dentro de 30 días). @return
	// true si expira pronto
