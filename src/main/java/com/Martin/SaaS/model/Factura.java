...
/**
 * Entidad Factura - Representa una factura generada por una suscripción.
 * Se genera automáticamente cada 30 días o por cambios de plan (prorrateo).
 */
@Entity
@Table(name = "facturas")
@Audited
...
public class Factura {
    ...
    public void calcularTotales() {
        ...
        this.impuesto = baseImponible.multiply(porcentajeImpuesto)
     ...
     * @return true si está pendiente y la fecha de vencimiento ha pasado
     */
