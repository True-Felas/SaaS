 ...
 * Auditada con Envers para tracking completo de cambios de plan.
 */
@Entity
...
public class Suscripcion {
    ...
    /**
     * Añade una factura a la suscripción.
    ...
    /**
     * Calcula los días restantes hasta el próximo cobro.
     * @return Número de días hasta el próximo cobro
     */
    ...
    /**
     * Calcula los días transcurridos desde el último cobro.
     * @return Número de días desde el último cobro
     */
     ...
     * @return true si está activa o en trial
     */
    ...
    /**
     * Verifica si es momento de generar una nueva factura.
     * @return true si la fecha actual es igual o posterior a la fecha de próximo cobro
     */
    public boolean debeCobrar() {
        return estaActiva() && 
               fechaProximoCobro != null && 
               !LocalDate.now().isBefore(fechaProximoCobro);
    }

    /**
     * Cancela la suscripción con un motivo.
