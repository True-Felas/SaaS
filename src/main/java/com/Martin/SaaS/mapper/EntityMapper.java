...
public class EntityMapper {
    ...
    public PlanDTO toPlanDTO(Plan plan) {
        ...
        return PlanDTO.builder()
                ...
                .almacenamientoGb(plan.getAlmacenamientoGb())
                .maxProyectos(plan.getMaxProyectos())
                .soportePrioritario(plan.getSoportePrioritario())
                .apiAcceso(plan.getApiAcceso())
                .analyticsAvanzados(plan.getAnalyticsAvanzados())
                .integracionesExternas(plan.getIntegracionesExternas())
                .build();
    }
    ...
    public SuscripcionDTO toSuscripcionDTO(Suscripcion suscripcion) {
        ...
        return SuscripcionDTO.builder()
                ...
                .usuarioEmail(suscripcion.getUsuario().getEmail())
                .planId(suscripcion.getPlan().getId())
                .planNombre(suscripcion.getPlan().getNombre())
                .planTipo(suscripcion.getPlan().getTipo().name())
                ...
                .autoRenovacion(suscripcion.getAutoRenovacion())
                .build();
    }
    ...
    public FacturaDTO toFacturaDTO(Factura factura) {
        ...
        return FacturaDTO.builder()
                ...
                .periodoInicio(factura.getPeriodoInicio())
                .periodoFin(factura.getPeriodoFin())
                .fechaEmision(factura.getFechaEmision())
                .fechaVencimiento(factura.getFechaVencimiento())
                .fechaPago(factura.getFechaPago())
                .concepto(factura.getConcepto())
                .diasProrrateados(factura.getDiasProrrateados())
                .planAnterior(factura.getPlanAnterior())
                .planNuevo(factura.getPlanNuevo())
                .build();
    }
}
